...
Ratings are automatically scraped from race results and calculated based on **time gaps**:
...
The scraper runs daily at 22:00 UTC automatically.

## Adding New Races

Edit `CYCLOCROSS24_RACES` in `scraper.py`. Find race IDs from cyclocross24.com URLs.
